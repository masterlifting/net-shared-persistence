...
public sealed class MongoDbReaderRepository : IPersistenceNoSqlReaderRepository
{
    ...
    public Task<T?> GetCatalogById<T>(int id, CancellationToken cToken) where T : class, IPersistentNoSql, IPersistentCatalog
    {
        throw new NotImplementedException();
    }

    public Task<T?> GetCatalogByName<T>(string name, CancellationToken cToken) where T : class, IPersistentNoSql, IPersistentCatalog
    {
        throw new NotImplementedException();
    }

    public Task<T[]> GetCatalogs<T>(CancellationToken cToken) where T : class, IPersistentNoSql, IPersistentCatalog
    {
        throw new NotImplementedException();
    }

    public Task<Dictionary<int, T>> GetCatalogsDictionaryById<T>(CancellationToken cToken) where T : class, IPersistentNoSql, IPersistentCatalog
    {
        throw new NotImplementedException();
    }

    public Task<Dictionary<string, T>> GetCatalogsDictionaryByName<T>(CancellationToken cToken) where T : class, IPersistentNoSql, IPersistentCatalog
    {
        throw new NotImplementedException();
    }
