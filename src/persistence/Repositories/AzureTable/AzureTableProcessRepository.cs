...
public class AzureTableProcessRepository<TContext, TEntity>(TContext context) : IPersistenceProcessRepository<TEntity>
    where TContext : AzureTableContext
    where TEntity : IPersistentProcess, ITableEntity
{
